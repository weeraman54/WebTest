...
const ProductDetailPage: React.FC<ProductDetailPageProps> = ({
  ...
  if (product) {
    onAddToCart(product.id);
    navigate('/checkout'); // Adjust path if your checkout route is different
  }
};
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="space-y-6">
              {/* Title and Category */}
              <div>
                <p className="text-[1.8rem] font-bold text-gray-900 mb-4">
                  {product.name}
                </p>
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  id='checkout-page-add-to-cart-button'
                >
  ...
  id="checkout-page-buy-now-button"
>
  Buy Now
</button>
              </div>
